    ...
    <div className="Navbar w-full flex items-center justify-between  py-2  bg-transparent relative z-50">
      ...
      <div className="nav-right items-center gap-8 flex mr-6 md:mx-12 ">
        ...
        {!user ? (
          <div className="authenticateButtons md:flex gap-4 hidden ">
            <button
              ...
              className=" flex items-center  bg-gradient-to-r from-[#449395] to-[#73F7FB] font-bold text-sm text-[#001C3C] py-2 px-6 rounded-3xl hover:ring-2  hover:ring-slate-100 transition ease-in duration-150  "
            >
              Login
            </button>
            <button
              onClick={() => navigate("/signup")}
              className=" md:flex items-center  hidden  text-[#001C3C] bg-gradient-to-r from-[#449395] to-[#73F7FB] text-center text-sm font-bold py-2 px-8 rounded-3xl hover:ring-2  hover:ring-slate-100 transition ease-in duration-150"
            >
              Sign Up
            </button>
          </div>
          ...
          <div className="logoutbtn">
            <button
              ...
              className=" md:flex items-center  text-[#001C3C] bg-gradient-to-r from-[#449395] to-[#73F7FB] text-center text-xs md:text-sm font-bold md:py-2 md:px-8  py-1 px-4 rounded-3xl hover:ring-2  hover:ring-slate-100 transition ease-in duration-150"
            >
              Logout
            </button>
          </div>
        ...
        >
          ...
          { toggleAuthenticate && <div className="authenticate-scroll  bg-white text-black absolute top-12 right-8 z-40 border-white border  flex-col items-center py-2  h-20 translate-x-4 animate-in w-20 rounded-xl shadow-2xl shadow-teal-400">
            <div onClick={()=>navigate('/login')} className="authDropDowncursor-pointer  px-4 transition-all duration-100 ease-in  hover:bg-[#1D2A3F] hover:text-white w-full rounded-md text-sm ">Login</div>
            <div onClick={()=>navigate('/signup')} className="authDropDowncursor-pointer  px-4 transition-all duration-100 ease-in  hover:bg-[#1D2A3F] hover:text-white w-full rounded-md text-sm ">SignUp</div>
          </div>}
        </div>}
      </div>
    </div>
